...
username=team17-picocluster5-user
contextname=team17-pico5-context
configname=pico5/team17-pico5-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
...
username=team18-picocluster5-user
contextname=team18-pico5-context
configname=pico5/team18-pico5-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
...
username=team19-picocluster5-user
contextname=team19-pico5-context
configname=pico5/team19-pico5-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
...
username=team20-picocluster5-user
contextname=team20-pico5-context
configname=pico5/team20-pico5-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
