...
username=team17-picocluster1-user
contextname=team17-pico1-context
configname=pico1/team17-pico1-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
...
username=team18-picocluster1-user
contextname=team18-pico1-context
configname=pico1/team18-pico1-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
...
username=team19-picocluster1-user
contextname=team19-pico1-context
configname=pico1/team19-pico1-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
...
username=team20-picocluster1-user
contextname=team20-pico1-context
configname=pico1/team20-pico1-config
#create namespace
envsubst < ./team-namespace.yaml | kubectl apply -f -
